...
public class UserService : IUserService
{
    ...
    public UserService(IUserRepository userRepository, IConfiguration configuration, IWebHostEnvironment webHostEnvironment, IGenericRepository<User> genericRepository)
    {
