...
public class OrderRepository : IOrderRepository
{
    ...
    public JsonResult GetActiveOrderId()
    {
        var finalData = new JsonResult(_context.Orders.Where(o => o.OrderStatusId == 6).Select(o => new
        {
            o.OrderId,
            o.CustomerId,
            CustomerName = _context.Customers.Where(c => c.CustomerId == o.CustomerId).Select(c => c.Name).FirstOrDefault(),
            Tables = _context.CustomerTables.Where(r => r.CustomerId == o.CustomerId && r.Isactive == true).Select(table => table.Table.TableName).ToList(),
        }).ToList());
        return finalData;
    }
